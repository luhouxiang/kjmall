            ...
            <div class="product-minheight">
              ...
              <div class="product-button public-pl67 fn-clear marginFR25">
                ...
                <div class="btn-con">
                  ...
                  <a id="btnAddCart" href="javascript:;" onclick="javascript:AjaxAddCart(<?php echo ($goods["goods_id"]); ?>,1,0);" class="btn btn-ent flyShop">加入购物车</a> <a id="btnAvailableInform" href="javascript:void(0)" class="btn hide">到货通知</a> </div>
              </div>
              <!-- 提交按钮 end ]]--> 
            </div>
            <!-- 温馨提示 start -->
