     ...
     <section class="content">
		...
		<div class="row">
                    ...
                    <div class="box  box-success">
				        <div class="box-body">
				        	<div class="info-box">
					         	<table class="table table-bordered">
					         		<tr>
					         			<td>程序版本：</td><td>BKshop <?php echo ($sys_info["version"]); ?></td>
					         			<td>更新时间：</td><td>2016-07-01</td>
					         			<td>程序开发：</td><td>深圳捌叁壹区块链网络科技</td>			         			
					         		</tr>
					         		<tr>
					         			<td>版权所有：</td><td>深圳捌叁壹区块链网络科技</td>
					         		</tr>
					         	</table>
				         	</div>
				        </div>
          ...
          <!-- <div class="callout callout-success">
            <p> <b>BKshop</b>--( Thinkphp shop的简称 ) B2C 开源商城    包含(pc + wap + android + ios + 微商城)多终端 </p>
          </div> -->
     </section>
 </div>
 </body>
